...
def main() -> int:
    ...
    COVERAGE_BASELINE.write_text(json.dumps({"coverage_pct": pct}, indent=2), encoding="utf-8")
    ...
    SIZE_BASELINE.write_text(json.dumps({"size": size, "files": files}, indent=2), encoding="utf-8")
