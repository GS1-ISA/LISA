...
const navigation = [
  { name: 'Dashboard', href: '/', icon: HomeIcon, roles: ['user', 'researcher', 'admin'] },
  { name: 'Research', href: '/research', icon: DocumentTextIcon, roles: ['researcher', 'admin'] },
  { name: 'Compliance', href: '/compliance', icon: ChartBarIcon, roles: ['user', 'researcher', 'admin'] },
  { name: 'Agents', href: '/agents', icon: CogIcon, roles: ['admin'] },
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-full max-w-xs flex-col bg-white dark:bg-gray-800">
          <div className="flex h-16 flex-shrink-0 items-center justify-between px-4">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">ISA Platform</h2>
            <button
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
          ...
          <nav className="flex-1 flex flex-col divide-y divide-gray-200 dark:divide-gray-700 overflow-y-auto">
